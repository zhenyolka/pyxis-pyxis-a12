...
PRODUCT_COPY_FILES += \
    vendor/potato/etc/permissions/vendor.lineage.biometrics.fingerprint.inscreen.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/vendor.potato.biometrics.fingerprint.inscreen.xml
